                ...
                <table class="table table-hover">
                    ...
                    foreach ($memberquery->result() as $rows) {
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Facebook Member</td>
                                <td><?php echo $rows->member_fb ?>
                            </tr>
                            <tr>
                                <td>Steam URL</td>
                                <td><?php echo $rows->member_steam ?>
                            </tr>
                            ...
                            <table class="table table-hover">
                                ...
                                foreach ($memberquerymodal->result() as $rows) {
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Facebook Member</td>
                                            <td><input type="text" name="memberfacebook" value="<?php echo $rows->member_fb ?>" required=""/></td>
                                        </tr>
                                        <tr>
                                            <td>Steam URL</td>
                                            <td><input type="text" name="membersteamurl" value="<?php echo $rows->member_steam ?>" required=""/></td>
                                        </tr>
